# most source from http://stackoverflow.com/questions/39048654/how-to-enable-directory-indexing-on-github-pages
# Edited to recursively iterate and ignore .git and .sass-cache directories
# also to not build an index.html file if one already exists in that directory
...
EXCLUDED = ['index.html', '.git', '.sass-cache']
...
#    header = os.path.basename(dir)
    ...
    if not 'index.html' in sorted(os.listdir(dir)): # if index.html doesn't already exist in this directory
